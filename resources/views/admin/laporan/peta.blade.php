                        ...
                        <div class="popup-body">
                            ...
                            <!-- TOMBOL AKSI -->
                                <div class="d-flex gap-2 border-top pt-3 mt-2">
                                    ...
                                    <a href="{{ route('admin.laporan.show', $item->id) }}" class="btn btn-primary btn-sm fw-bold w-100 d-flex align-items-center justify-content-center shadow-sm text-white" style="border-radius: 8px; padding: 8px; color: #ffffff !important;">
