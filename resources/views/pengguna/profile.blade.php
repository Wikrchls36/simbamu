...
<head>
    ...
    <style>
        ...
        .profile-card { border-radius: 8px; border: 1px solid #ccc; background: #fff; max-width: 650px; margin: 0 auto; } 
...
<div class="container mt-5 mb-4 flex-grow-1">
    <div class="profile-card p-5 shadow-sm">
        ...
        <form action="/pengguna/profile" method="POST" id="profileForm">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text" name="no_whatsapp" class="form-control" value="{{ old('no_whatsapp', $user->no_whatsapp) }}" placeholder="Contoh: 08123456789">
            </div>
            
            <p class="text-muted mb-2" style="font-size: 13px;">*Kosongkan kolom password di bawah ini jika tidak ingin mengubah password lama.</p>
            ...
            <div class="row mb-5">
                <div class="col-md-6 mb-3 mb-md-0">
                    ...
                    <div class="password-container">
                        <input type="password" name="password" id="password" class="form-control" placeholder="Password baru" minlength="8">
                        <i class="fas fa-eye toggle-password" onclick="toggleVisibility('password', this)"></i>
                    </div>
                    <small class="text-muted mt-1 d-block" style="font-size: 12px;">*Gunakan minimal 8 karakter.</small>
                </div>
