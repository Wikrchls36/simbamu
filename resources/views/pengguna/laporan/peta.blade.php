...
<body>
    ...
    <a href="{{ route('pengguna.laporan.index') }}" class="btn-back-floating" title="Kembali ke Log"><i class="fas fa-arrow-left"></i></a>
                    ...
                    <div class="popup-custom">
                        ...
                        <div class="popup-body">
                            ...
                            <div class="d-flex gap-2 border-top pt-3 mt-3">
                                <a href="/pengguna/laporan/{{ $item->id }}/detail" class="btn btn-primary btn-sm fw-bold w-100 d-flex align-items-center justify-content-center shadow-sm text-white" style="border-radius: 8px; padding: 8px;">
